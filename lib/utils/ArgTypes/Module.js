...
module.exports = [function command(a, msg, flag, bot) { bot.commands.find(c => flag === "strict" ? c.id === a : c.id.startsWith(a) || (c.aliases && c.aliases.includes(a))); },
  function event(a, msg, flag, bot) { bot.events.find(e => flag === "strict" ? c.id === a : e.id.toLowerCase().startsWith(a)); },
  function module(a, bot) { bot.commands.find(c => c.id.toLowerCase().startsWith(a) || (c.aliases && c.aliases.includes(a))); },
];
