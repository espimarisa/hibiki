...
class prefixCommand extends Command {
  ...
  async run(msg, args) {
    ...
    if (!prefix.length) return msg.channel.createMessage(this.bot.embed("🤖 Prefix", `The prefix in this server is \`${guildcfg && guildcfg.prefix.length || !guildcfg.prefix.length ? guildcfg.prefix : this.bot.cfg.prefix}\``));
