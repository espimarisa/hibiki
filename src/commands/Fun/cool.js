...
class coolCommand extends Command {
  ...
  run(msg, args, pargs) {
    ...
    if (user.id === "150628341316059136") return msg.channel.createMessage(this.bot.embed("😎 Not Cool", `Despite the fact that a **${user.username}** is not gay, a **${user.username}** cannot be cool as a side effect fromt hat.`));
