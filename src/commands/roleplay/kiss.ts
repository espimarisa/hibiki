...
export class KissCommand extends HibikiCommand {
  description = "Kiss another server member!";
  ...
  public async runWithInteraction(interaction: ChatInputCommandInteraction) {
    ...
    let image = "https://purrbot.site/img/sfw/kiss/gif/kiss_096.gif";
    ...
    await interaction.followUp({
      embeds: [
        {
          description: interaction.getString("roleplay.COMMAND_KISS_DESCRIPTION", {
